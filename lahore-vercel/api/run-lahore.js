...
const { LAHORE_AREA_KEYS } = require("./_lib/lahore");
...
module.exports = async (req, res) => {
  ...
  if (areas.length === 0 && !customSearchUrl) {
    json(res, 400, { error: "Select at least one Lahore area or provide customSearchUrl." });
    return;
  }
  ...
  try {
    ...
    json(res, 200, {
      ok: true,
      message: "Lahore workflow dispatched successfully.",
      areas,
      maxPages,
      maxListings,
      filterTokens,
